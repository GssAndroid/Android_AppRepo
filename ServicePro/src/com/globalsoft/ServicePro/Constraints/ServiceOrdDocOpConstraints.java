...
public class ServiceOrdDocOpConstraints  implements KvmSerializable, Serializable {
    ...
    public String PROCESS_QTY_UNIT = "";  
    public String ZZITEM_DESCRIPTION = "";
    public String ZZITEM_TEXT = "";
    //public String ZZFIELDNOTE = "";
    
    
    public ServiceOrdDocOpConstraints (){}
    

    public ServiceOrdDocOpConstraints (String[] values) {
        OBJECT_ID = values[0];
        PROCESS_TYPE = values[1];  
        //ZZFIRSTSERVICEITEM = values[2];
        ZZKEYDATE = values[2];
        PARTNER = values[3];
        NAME_ORG1 = values[4];
        NAME_ORG2 = values[5];
        ...
        NUMBER_EXT = values[33];
        PRODUCT_ID = values[34];
        QUANTITY = values[35];
        PROCESS_QTY_UNIT = values[36];
        ZZITEM_DESCRIPTION = values[37];
        ZZITEM_TEXT = values[38];
        //ZZFIELDNOTE = values[38];
    ...
    public Object getProperty(int arg0) {        
        switch(arg0) {
            ...
            case 35:
                return QUANTITY;
            case 36:
                return PROCESS_QTY_UNIT;
            case 37:
                return ZZITEM_DESCRIPTION;
            case 38:
                return ZZITEM_TEXT;
           /* case 38:
                return ZZFIELDNOTE;*/
    ...
    public void getPropertyInfo(int index, Hashtable arg1, PropertyInfo info) {
        switch(index){
           ...
           /* case 2:
            ...
            case 36:
                info.type = PropertyInfo.STRING_CLASS;
                info.name = "PROCESS_QTY_UNIT";
                break;   
            case 37:
                info.type = PropertyInfo.STRING_CLASS;
                info.name = "ZZITEM_DESCRIPTION";
                break;   
            case 38:
                info.type = PropertyInfo.STRING_CLASS;
                info.name = "ZZITEM_TEXT";
                break;  
            /*case 39:
                info.type = PropertyInfo.STRING_CLASS;
                info.name = "ZZFIELDNOTE";
                break;  */ 
        ...
        switch(index){
           ...
           /* case 2:
            ...
            case 35:
                ...
                break;
            case 36:
                PROCESS_QTY_UNIT = value.toString();
                break;
            case 37:
                ZZITEM_DESCRIPTION = value.toString();
                break;
            case 38:
                ZZITEM_TEXT = value.toString();
                break;
           /* case 39:
            	ZZFIELDNOTE = value.toString();
                break;    */
    ...
    }//fn getProcessQtyUnit
    
    public String getZZItemDesc(){
        return this.ZZITEM_DESCRIPTION;
    }//fn getZZItemDesc
    
    public String getZZItemText(){
        return this.ZZITEM_TEXT;
    }//fn getZZItemText
    
   /* public String getFieldNotes(){
        return this.ZZFIELDNOTE;
    }//fn getZZItemText
...
*/                
}//End of class ServiceOrdDocOpConstraints 
