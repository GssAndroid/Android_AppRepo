...
public class ServiceProColleaguesOpConstraints implements KvmSerializable, Serializable {
    ...
    public ServiceProColleaguesOpConstraints (){}    

    public ServiceProColleaguesOpConstraints (String[] values) {
        PARTNER = values[0];
        MC_NAME1 = values[1];
        MC_NAME2 = values[2];
        TEL_NO = values[3];
...
}//End of class ServiceProColleaguesOpConstraints